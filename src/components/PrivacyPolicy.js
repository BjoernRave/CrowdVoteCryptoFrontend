  ...
  return (
    <div className="policy">
      ...
      <p>
        ...
        have associated with that data. This Privacy Policy for CrowdVoteCrypto
        is powered by{" "}
      ...
      <p>
        ...
        our Terms and Conditions, accessible from crowdvotecrypto.com
      </p>
      ...
      <p>CrowdVoteCrypto uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        CrowdVoteCrypto will take all steps reasonably necessary to ensure that
      ...
      <p>
        CrowdVoteCrypto may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of CrowdVoteCrypto</li>
        <li>
      ...
      <ul>
        <li>By email: enterravement@gmail.com</li>
      </ul>
    </div>
  );
};
