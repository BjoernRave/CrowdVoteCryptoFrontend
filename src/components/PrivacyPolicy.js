...
export default () => {
  return (
    <div className="policy">
      ...
      <br />
      <h3>Effective date: July 18, 2018</h3>
      <br />
      <p>
        CrowdVoteCrypto ("us", "we", or "our") operates the crowdvotecrypto.com
        ...
        Service and the choices you have associated with that data. This Privacy
        Policy for CrowdVoteCrypto is powered by FreePrivacyPolicy.com. We use
        your data to provide and improve the Service. By using the Service, you
        ...
        Conditions, accessible from crowdvotecrypto.com Information Collection
        ...
        address Cookies and Usage Data Usage Data We may also collect
        information how the Service is accessed and used ("Usage Data"). This
        ...
        certain information. Cookies are files with small amount of data which
        ...
        purposes. Use of Data CrowdVoteCrypto uses the collected data for
        various purposes: To provide and maintain the Service To notify you
        ...
        those from your jurisdiction. If you are located outside Germany and
        choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Germany and process it there. Your
        consent to this Privacy Policy followed by your submission of such
        information represents your agreement to that transfer. CrowdVoteCrypto
        ...
        Legal Requirements CrowdVoteCrypto may disclose your Personal Data in
        ...
        CrowdVoteCrypto To prevent or investigate possible wrongdoing in
        connection with the Service To protect the personal safety of users of
        the Service or the public To protect against legal liability Security Of
        Data The security of your data is important to us, but remember that no
        method of transmission over the Internet, or method of electronic
        storage is 100% secure. While we strive to use commercially acceptable
        means to protect your Personal Data, we cannot guarantee its absolute
        security. Service Providers We may employ third party companies and
        individuals to facilitate our Service ("Service Providers"), to provide
        the Service on our behalf, to perform Service-related services or to
        assist us in analyzing how our Service is used. These third parties have
        ...
        own advertising network. You can opt-out of having made your activity on
        ...
        of any third party sites or services. Children's Privacy Our Service
        does not address anyone under the age of 18 ("Children"). We do not
        knowingly collect personally identifiable information from anyone under
        the age of 18. If you are a parent or guardian and you are aware that
        your Children has provided us with Personal Data, please contact us. If
